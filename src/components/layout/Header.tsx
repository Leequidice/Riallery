...
export default function Header() {
  ...
  return (
    <header
      className={cn(
        'fixed top-20 left-0 right-0 z-50 transition-all duration-300',
        'bg-transparent'
      )}
    >
          ...
          >
            <div className="flex items-center">
              <div className="flex space-x-1 mr-3">
                <div className="w-2 h-6 bg-primary-400"></div>
                <div className="w-2 h-6 bg-white"></div>
                <div className="w-2 h-6 bg-primary-400"></div>
              </div>
              <span className="text-xl font-light text-white tracking-widest">riallery</span>
            </div>
          </Link>
